    ...
    <div>
      <Card className="mb-12 md:bg-zinc-900 md:border-zinc-800 bg-transparent border-transparent">
        ...
        <CardContent className="hyphens-auto text-base md:text-xl">
          ...
          <p className="text-zinc-400 font-semibold">2023/01/24</p>
      ...
      <Card className="mb-12 md:bg-zinc-900 md:border-zinc-800 bg-transparent border-transparent">
        ...
        <CardContent className="hyphens-auto text-base md:text-xl">
          ...
          <p className="mt-2 text-muted-foreground hyphens-auto pt-2">
            ...
            &quot;elegant böse Verhalten&quot; in einem absoluten Alltagskombi
            ,womit die Prägung &quot;RS&quot; mehr als gerechtfertigt ist.
            <br />
            <br />
            Unser RS6 hat den klassischen Turboschmiede &quot;Overhaul&quot;
            bekommen bestehend aus folgenden Komponenten:
          </p>
